...
class ContentAnalysisAgent:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.api_key = self.config.get('api_key') or settings.CONTENT_ANALYSIS_AGENT_API_KEY
        self.base_url = self.config.get('base_url') or settings.CONTENT_ANALYSIS_AGENT_BASE_URL
        self.model_name = self.config.get('model_name') or settings.CONTENT_ANALYSIS_AGENT_MODEL_NAME

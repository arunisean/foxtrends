...
### 1. **BettaFish** - 多智能体舆情分析系统（根目录）

"**微舆**" 是一个从0实现的创新型多智能体舆情分析系统，帮助大家破除信息茧房，还原舆情原貌，预测未来走向，辅助决策。

**项目路径**: 根目录（`/`）  
**主要功能**: 舆情监控、多模态分析、智能报告生成  
**技术栈**: Python, Flask, Multi-Agent System  
**文档**: 见下方详细说明

### 2. **FoxTrends** - 垂直社区需求追踪系统（`/FoxTrends/`）
...
- FoxTrends 将 BettaFish 的 Agent 系统改造为需求追踪场景
- 两个项目独立运行，互不干扰
